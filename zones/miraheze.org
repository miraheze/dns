...
;; DMARC - Policy: Quarantine - receivers may mark as spam, junk etc.
_dmarc		TXT	"v=DMARC1; p=quarantine; rua=mailto:dmarc@miraheze.org; ruf=mailto:dmarc@miraheze.org; fo=1; adkim=r; aspf=r; pct=100; rf=afrf; ri=86400; sp=none"
